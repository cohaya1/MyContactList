...
public class ContactActivity extends AppCompatActivity implements com.example.mycontactlist.DatePickerDialog.SaveDateListener {
    ...
    private void setForEditing(boolean enabled) {
        ...
        EditText editPhone = (EditText) findViewById(R.id.editHome1);
